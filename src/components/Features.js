...
export default function Features() {
  return (
    <div>
      <img src={hero2} alt="" />
      <h1 className="text-3xl font-semibold p-4 mt-4">
        Make your <span className="text-purple-600">Learning</span> Enjoyable
      </h1>
      ...
      <div>
        <div className=" p-4 shadow-md rounded-lg m-4 bg-white overflow-hidden text-sm transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-95 hover:duration-500 ...">
